...
description = "How markets encourage bad behaviors and what alternative we have"
date = 2022-02-05
draft = true
+++

In this article we want to better understand what a market economy is, why we need an alternative and how it could look like.
...
In the scope of this article, we will define price as the monetary value you need to buy a product.

A product is anything that can be exchanged for money, such as goods, services and labor.

A buyer is a person or a group of people that want to exchange money for a given product sold in the market. They can freely decide what products to buy, their only limitation is the amount of money available.

A seller is a person or a group of people whose goal is to sell a product on the market for a profit. They can freely decide how to acquire the product and what to sell, even though in practice they are limited by the capital available and their environment.
...
In theory sellers can decided by themselves at what price sell their products, however  higher the price, less people will actually buy it.
...
Vice versa, when there are more products than needed (high supply), seller will have to low price to be able to sell it.
...
Still, why should a seller low the price? It's because there is another competition going on, the one between sellers. A healthy market **needs** many competing sellers over the same product to ensure a fair price.
...
There are many factors that influence market share, economic often focus on price. Given two equivalent product, a smart buyer will buy the cheaper one, hence a lower price will give sellers a bigger piece of the pie. It may seems counter-intuitive, but the logic is that I can try to sell apples at 1$/kg, but then only sell 20kg and gain $20, or I can lower the price at 0.80$/kg, which will allow me to sell 30kg and gain $24, $4 more than before.
...
The opposite extreme is a fully-regulated market where the State is in full control of sales and production.
...
Now that we have a good understanding of what markets are, we can explore the issues they create when applied to real life.

## Tendency to Monopolies
...
Given the chance, every business will have the tendency to band up with others because by doing so they solidify their power in the market.
...
Another example are the hedge-fund manager who earn hundreds times more than a nurse. We could debate on which job provide greater benefits to society, but we should all agree that the value provided by the manager will never be hundreds times more than the nurse.
...
This is particularly dangerous when it comes to the idea of free markets. Markets if anything, incentivize competition over everything else, and when there is fierce competition the powerful will prey upon the weak. Slavery in the eye of markets economy is a good way to reduce costs and improve profits. Environmental regulations instead are a big nuisance because they increase costs, possibly cutting out profitable industries such as coal and oil extraction. There is no malice, only economy.

History, together with today labor market and climate crisis, teach us that we cannot be trusted when competition is on and our quality of life depends on it. We will exploit all that we can.
...
Cutting quality on goods is even better. If a seller introduce in the market a product that is very durable and can be easily repaired, after a while they will exhaust demand and thus reduce their profits.

This is why the [Phoebus Cartel](https://en.wikipedia.org/wiki/Phoebus_cartel) was instituted, why [planned obsolescence](https://en.wikipedia.org/wiki/Planned_obsolescence) is inevitable, and why [repairing goods must be hard](https://en.wikipedia.org/wiki/Right_to_repair).
...
This issue isn't limited to only physical goods, think for example about the majority of software programs that you use. Many of them are pretty bad because the business decided to cut on labor to produce or maintain it.
...
It is true that markets encourage people do things differently in the hope to win over the endless competition. This is the main argument used by market advocates to promote markets as the engine of innovation.
...
Markets incentivize you to keep innovations for yourself as much as you can. Just think of China's silk production method or Coca-Cola (Coke) secret recipe; people have died to ensure it remained a secret.

However secrets hinder progress. By hiding information, by hiding a better way of doing something, you are *excluding* all others from possibly improving it even further.

This understanding is one of the reason why [patents](https://en.wikipedia.org/wiki/Patent), and [intellectual property rights](https://en.wikipedia.org/wiki/Intellectual_property) more broadly, have become more and more relevant in market economy.
...
Notice how the language used for patents is exactly the one of secrets: to *exclude* other people. Because keeping a secret is really hard, especially in an increasingly connected world, patents give you the same exclusion benefit of secrets, while avoiding all the hassle.

The initial intent behind patents may have been good, however they are becoming increasingly problematic and are once again hindering progress.

The scope of patents has broadened up, to the point that it has become much more difficult to come up with an innovation that doesn't infringe this or that patent. Furthermore, patents can be sold, hence many wealthy businesses understood that by racking in as many as possible, they can raise the barrier of entry for a given market even more. This is yet another way how sellers try to control a market.

Regulations tried to counter the hinder of progress in markets by creating a new way to exploit it.

Another reason why market economy hinder progress is because the social structure that derives from it could be disrupted by certain kind of innovation. Automation is one of the most important area for progress, but also one of the most dangerous to markets societies. The reason is simple: most people profits comes from waged labor; automation main goal is to *replace* human labor with machines, essentially cutting out participation in the market for hundreds of million of people. Most of these people will not be able to quickly find a new source of profits, creating a bad effect on the market economy at large.
...
One important component of progress is failure. We need to try countless experiments, to deeply study nature, come up with different alternative design and formulae, before we can come up with something innovative and groundbreaking. In one word, we need research. All of these efforts and failure are rejected by markets. Markets is a tool to exchange products that self-optimize for profits; research and development is the exact opposite of it, given that we need to burn through quite some time and resources.

That's why in a society heavily built around markets, such as capitalism, progress will be further hindered by this aversion for research. Here we should understand that it isn't the fault of markets, but rather a problem of using the wrong tool, like trying to drive a nail with a screwdriver.
